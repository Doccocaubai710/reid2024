import numpy as np
from app.tracker.trackers.utils import get_prev_box
from app.tracker.trackers.kalman_filter import KalmanFilter
...
class Track(BaseTrack):
    ...
    def update(self, frame_id, detection):
        ...
        self.end_frame_id = frame_id
        self.state = TrackState.Tracked if len(self.history.keys()) >= 3 else TrackState.New
