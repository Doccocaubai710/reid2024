...
from app.offline_processing.id_switch import Tracklet, extract_id_switches_from_log, filter_nearby_switches
...
def dist_based_re_ranking(original_dist, k1=20, k2=6, lambda_value=0.3):
    ...
    return final_dist
def split_tracklets_from_log(tracklets, log_file="/home/aidev/workspace/reid/Thesis/reid-2024/trash/2025-05-29 03-13-57-0f8c8cdfaab24f26a41026671d9eb40d/example.log"):
    """
...
def process_session(session_dir, video_path=None):
    ...
    saved_images = extract_tracklet_mean_frames(
        ...
        video_path="/home/aidev/workspace/reid/Thesis/reid-2024/app/assets/videos/cam1.mp4",
        output_dir=os.path.join("/home/aidev/workspace/reid/Thesis/reid-2024/Screenshot", "mean_feature_frames_cam1"),
...
def main():
    ...
    parser.add_argument("--log_file", type=str, default="/home/aidev/workspace/reid/Thesis/reid-2024/trash/2025-05-29 03-13-57-0f8c8cdfaab24f26a41026671d9eb40d/example.log",
